package Tools_Task_12;
use Exporter(import);
@EXPORT = qw ( login reg_user del_user change_passwd print_help );
...
# путь до файла help.txt
my $help_path = "C:\\pl\\perl_problems\\files\\help.txt";
